...
Murmur is a cross-platform desktop speech-to-text application built with Tauri 2.x (Rust backend + React/TypeScript frontend). It is a productized fork of [Handy](https://github.com/cjpais/Handy) by CJ Pais; the Rust crate/binary names (`handy`, `handy_app_lib`) and `HANDY_*` env vars still carry the upstream name pending a later rename phase.
...
- **Opening an issue:** Read [`.github/ISSUE_TEMPLATE/`](.github/ISSUE_TEMPLATE/). Blank issues are disabled; pick the right template (`bug_report.md` for bugs). Feature requests do not belong in issues — they go to [Discussions](https://github.com/kylebegeman/murmur/discussions) (see `.github/ISSUE_TEMPLATE/config.yml`).
- **Translations:** Follow [CONTRIBUTING_TRANSLATIONS.md](CONTRIBUTING_TRANSLATIONS.md).
- **Full contributor workflow:** [CONTRIBUTING.md](CONTRIBUTING.md).
- **Upstream:** Do not open PRs/issues against [cjpais/Handy](https://github.com/cjpais/Handy) for work on this fork; upstream has its own workflow and policies.
